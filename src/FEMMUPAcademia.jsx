...
<Button
  ...
  className="group h-12 min-w-[180px] px-6 py-2 !rounded-full !border-0  !bg-[#e9e1e1] hover:!bg-[#e9e1e1] active:!bg-[#e9e1e1] transition-all duration-300"
>
  <span className="bg-gradient-to-br from-[#000000] to-[#d19898] bg-clip-text text-transparent font-medium group-hover:from-[#d19898] group-hover:to-[#000000]">
    Programa
  </span>
  ...
  className="group h-12 min-w-[180px] px-7 py-2 !rounded-full !border-0  !bg-black hover:!bg-black active:!bg-black text-white tracking-widest uppercase text-sm shadow-md hover:scale-105 transition-all duration-300 focus:outline-none focus:ring-0"
          >
