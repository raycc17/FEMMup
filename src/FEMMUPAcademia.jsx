  ...
  {[...Array(80)].map((_, i) => {
    ...
    return (
      ...
      >
       ...
       <span className="inline-block scale-75 bg-gradient-to-b from-[#d49e9e] to-[#e9e1e1] bg-clip-text text-transparent opacity-70">
  ↑
</span>
          </div>
        ) : (
...
{view === "login" && (
  <motion.div
    initial={{ opacity: 0 }}
    animate={{ opacity: 1 }}
    className="min-h-screen flex flex-col items-center justify-start py-20 pb-30 px-6 overflow-y-auto bg-gradient-to-br from-[#c79a9a] via-[#5b3a3a] to-black"
  >
    {/* Logo */}
